...
-- 5. What is the total revenue per day?	
SELECT 
    date,
    total_revenue 
FROM product;	
...
-- 7. What is the total quantity sold and total revenue generated by year?
SELECT 
    year,
    SUM(quantity_p1 + quantity_p2 + quantity_p3 + quantity_p4) AS total_quantity_sold,
    SUM(revenue_p1 + revenue_p2 + revenue_p3 + revenue_p4) AS total_revenue
FROM 
    product 
GROUP BY 
    year
