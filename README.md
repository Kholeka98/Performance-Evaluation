...
1. What is the total revenue, total quantify sold, average revenue, and average quantity sold?
2. What is the average quantity sold for each product per year?
3. What is the total revenue generated by each product per year?
4. Which product had the highest total revenue by year?
5. What is the average revenue per day?	
6. What is the total quantity sold per month for all products combined in 2020?	
7. What is the total quantity sold by year?
8. What is the total quantity sold for each day of the week, grouped by year?
9. Which product had the highest total revenue in a 2022, and what was the total revenue for that product?
...
- Total Revenue: $223,254,377
- Total Quantity Sold: 45,505,716
- Average Revenue per Transaction: $51,583
- Average Quantity Sold per Transaction: 10,514
